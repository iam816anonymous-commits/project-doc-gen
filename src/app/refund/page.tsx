export default function RefundPage() {
  return (
    <div className="max-w-3xl mx-auto py-12 px-6 prose prose-blue">
      ...
      <p>Since Jules provides digital, non-tangible goods that are generated instantly, we generally do not offer refunds once the full documentation package is unlocked.</p>
