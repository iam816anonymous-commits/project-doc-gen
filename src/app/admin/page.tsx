    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          ...
          <div className={`px-4 py-2 rounded-lg font-bold text-sm ${isPaymentsEnabled ? 'bg-green-100 text-green-700' : 'bg-amber-100 text-amber-700'}`}>
            Payments: {isPaymentsEnabled ? 'ENABLED' : 'DISABLED (Testing Mode)'}
            <span className="block text-[10px] opacity-50 font-medium tracking-tight">Source: ENABLE_PAYMENTS env</span>
          </div>
        </div>
